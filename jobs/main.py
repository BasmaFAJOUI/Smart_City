...
# calculate mouvement-increment

LATITUDE_INCREMENT = (
    BIRMINGHAM_COORDINATES['latitude']-LONDON_COORDINATES["latitude"])/100
LONGITUDE_INCREMENT = (
    BIRMINGHAM_COORDINATES['longitude']-LONDON_COORDINATES["longitude"])/100
...
def generate_weather_data(device_id, timestamp, location):
    return {
        ...
        'location': location,
        'timestamp': timestamp,
        'tempertion': random.uniform(-5, 26),
...
def simulate_journey(producer, device_id):
    while True:
        ...
        traffic_camera_data = generate_traffic_camera_data(
            device_id, vehicle_data['timestamp'], vehicle_data['location'], 'nikon-camera123')
